...
def plot_perbandingan(df_summ, col_main, col1, col2, sortby):
    # Data prep
...
def plot_scatter(dataframe, y1, y2):
    fig = px.scatter(dataframe, 
                        x=y1, 
                        y=y2, 
                        hover_data=['Unique ID Outlet'],trendline="ols")
